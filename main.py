"""
TestGen — Automated test generation from code or docstrings
...
class Router:
    """Cost- and latency-aware model router for TestGen."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="TestGen: Automated test generation from code or docstrings")
